...
@section('content')
    ...
    <x-admin.hmtl.section>
        <x-admin.main.filter-form form-name="{{$formName}}" :row="$rowData" :export-view="false" :from-date="false" :to-date="false" :is-active="true" :continent="true" />
                ...
                <div class="card-body table-responsive p-0">
                    <table  {!!Table_Style($viewDataTable,$yajraTable) !!} >
                        ...
                        <tr>
                            ...
                            <th class="TD_100">{{__('admin/data/country.t_name')}}</th>
                            <th class="TD_100">{{__('admin/data/country.t_capital')}}</th>
                            <th class="TD_100">{{__('admin/data/country.t_currency')}}</th>
                            <th class="TD_100">{{__('admin/data/country.t_continent')}}</th>
